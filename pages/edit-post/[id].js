...
export default function Post() {
  ...
  return (
    <div className={container}>
      ...
      {!editing && (
        <div>
          {post.coverImagePath && <Image src={post.coverImagePath} className={coverImageStyle} alt="Cover Image" />}
          <h1>{post.title}</h1>
      ...
      <button className={button} onClick={() => setEditing(editing ? false : true)}>
